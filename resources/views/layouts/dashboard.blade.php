            ...
            <div class="dashboard-container">
                <div class="side-bar">
                    <ul class="side-bar-links">
                        <li>
                            <a href="" class="link">Il tuo profilo</a>
                        </li>
                        <li>
                            <a href="" class="link">Il tuo ristorante</a>
                        </li>
                        <li>
                            <a href="" class="link">I tuoi piatti</a>
                        </li>
                        <li>
                            <a href="" class="link">I tuoi ordini</a>
                        </li>
                        <li>
                            <a href="" class="link">Le tue statistiche</a>
                        </li>
